...
public class HomeWork2{
    ...
    public static void validateLogin(String login) throws LoginValidationException {
        ...
        /*
        * 1 выражения-любые буквы от a до z (строчные) один или более раз.
        * 2 выражение-тоже самое что и 1, но уже с заглавными один или более раз.
        * 3 выражение-любой числовой символ один или более раз.
        * 4 выражение-нижнее подчеркивание один или более раз.
        * 5 выражение-ищем символы [a-z] [A-Z] цифровой символ и нижнее почёркивание.
        * 6 выражение-длина, не менее 1 символа и не более 20.
        * ...................
        *(тут будут символы:
        ...
        * \\d-цифровой символ.
        * ?-одно повторение символа.
        * *-любое число повторений символа.)
        * */
        String err="^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[_])[A-Za-z\\d_]{1,20}$";
        if (!login.matches(err))
            throw new  LoginValidationException("invalid login");
        //если у логина нету символов из регулярного выражения то мы выкидываем ошибку.
    }
